    ...
    <section className={styles.main}>
      ...
      <article className={styles.presenterText}>
        ...
        <div className={styles.presenterText__content}>
          <div>
            <p>
              Добро пожаловать на наш сайт, посвященный истории и важной роли, которую женщины сыграли в русской
              революции 1917 года.
            </p>
            <p>
              Этот период русской истории был временем перемен, борьбы
              за равенство и социальную справедливость, и женщины стояли
